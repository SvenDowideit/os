...
func Read() (map[interface{}]interface{}, error) {
	...
	cmdLineObj := Parse(strings.TrimSpace(util.UnescapeKernelParams(string(cmdLine))))
...
func Parse(cmdLine string) map[interface{}]interface{} {
